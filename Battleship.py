...
def reglas():
        print("""
            ...
            𝟕) 𝐈𝐧𝐝𝐢𝐜𝐚𝐝𝐨𝐫 (🌊) 𝐞𝐬 𝐞𝐥 𝐩𝐫𝐢𝐧𝐜𝐢𝐩𝐚𝐥 𝐢𝐧𝐝𝐢𝐜𝐚𝐧𝐝𝐨 𝐞𝐥 𝐞𝐬𝐩𝐚𝐜𝐢𝐨 𝐪𝐮𝐞 𝐭𝐢𝐞𝐧𝐞𝐬 𝐞𝐧 𝐞𝐥 𝐭𝐚𝐛𝐥𝐞𝐫𝐨
            𝟖) 𝐈𝐧𝐝𝐢𝐜𝐚𝐝𝐨𝐫 (🚢) 𝐬𝐢𝐫𝐯𝐞 𝐩𝐚𝐫𝐚 𝐩𝐨𝐬𝐢𝐜𝐢𝐨𝐧𝐚𝐫 𝐭𝐮𝐬 𝐞𝐦𝐛𝐚𝐫𝐜𝐚𝐜𝐢𝐨𝐧𝐞𝐬 𝐞𝐧 𝐞𝐥 𝐭𝐚𝐛𝐥𝐞𝐫𝐨
            𝟗) 𝐈𝐧𝐝𝐢𝐜𝐚𝐝𝐨𝐫 (💥) 𝐯𝐚 𝐚 𝐚𝐩𝐚𝐫𝐞𝐜𝐞𝐫 𝐜𝐮𝐚𝐧𝐝𝐨 𝐝𝐞𝐫𝐫𝐢𝐛𝐞𝐬 𝐮𝐧 𝐛𝐚𝐫𝐜𝐨 𝐞𝐧𝐞𝐦𝐢𝐠𝐨 𝐨 𝐮𝐧 𝐛𝐚𝐫𝐜𝐨 𝐭𝐮𝐲𝐨 𝐬𝐞𝐚 𝐝𝐞𝐫𝐫𝐢𝐛𝐚𝐝𝐨
            𝟏𝟎) 𝐈𝐧𝐝𝐢𝐜𝐚𝐝𝐨𝐫 (⛔) 𝐚𝐩𝐚𝐫𝐞𝐜𝐞 𝐜𝐮𝐚𝐧𝐝𝐨 𝐟𝐚𝐥𝐥𝐚𝐬 𝐮𝐧 𝐭𝐢𝐫𝐨 𝐨 𝐞𝐥 𝐜𝐨𝐧𝐭𝐫𝐢𝐧𝐜𝐚𝐧𝐭𝐞 𝐟𝐚𝐥𝐥𝐚 𝐬𝐮 𝐭𝐢𝐫𝐨
...
def llamar_reglas():
    while True:  # lo ponemos en while para que se ejecute mientras no se ingrese una condicion valida
        ...
        elegir = input("""
                   ...
                   """)
        elegir = elegir.upper()  # ponemos todo en mayusculas para evaluarlos en los if
        if (
            elegir == "SI" or elegir == "SI."
        ):  # ponemos como condicion tanto SI como SI. No mas por si hay un chistoso
            reglas()
            break
            ...
            clear()
            break
        else: # Si no sucede nada de lo anterior, asumimos que el valor ingresado es invalido
            print("""
